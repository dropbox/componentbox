...
expect abstract class ComponentBoxViewModel<State : ComponentBoxState, Event : ComponentBoxEvent> : ViewModel<State, Event> {
    ...
    protected inline fun <reified Service : ComponentBoxService<Model, State, Event>, Model : ComponentBoxModel<State, Event>> componentBoxStateFlowOf(
        initialState: State
    ): StateFlow<ComponentBoxState>
}